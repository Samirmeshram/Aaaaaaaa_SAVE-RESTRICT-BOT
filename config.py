...
API_ID = int(os.environ.get("API_ID", "29895250"))
...
ADMINS = [int(admin) for admin in os.environ.get("ADMINS", "2017335429").split(",") if admin]
...
DB_NAME = os.environ.get("DB_NAME", "Dpcinema")
...
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1003854801157"))
